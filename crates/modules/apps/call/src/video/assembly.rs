...
pub mod tests {
    ...
    #[cfg_attr(test, test)]
    pub fn out_of_order_fragments_complete() {
    ...
    #[cfg_attr(test, test)]
    pub fn single_fragment_frame_completes_immediately() {
        let mut reassembler = Reassembler::default();
    ...
    #[cfg_attr(test, test)]
    pub fn incomplete_frame_replaced_by_newer_counts_as_dropped() {
        let mut reassembler = Reassembler::default();
    ...
    #[cfg_attr(test, test)]
    pub fn stale_older_or_duplicate_fragments_are_ignored() {
        let mut reassembler = Reassembler::default();
    ...
    #[cfg_attr(test, test)]
    pub fn completed_frame_nos_are_monotonic() {
        let mut reassembler = Reassembler::default();
