...
pub mod tests {
    ...
    #[cfg_attr(test, test)]
    pub fn exact_multiple_has_no_empty_tail() {
    ...
    #[cfg_attr(test, test)]
    pub fn empty_and_oversize_inputs_error() {
        assert!(matches!(
    ...
    #[cfg_attr(test, test)]
    pub fn decode_rejects_truncated() {
        assert!(matches!(
    ...
    #[cfg_attr(test, test)]
    pub fn decode_rejects_zero_frag_count() {
    ...
    #[cfg_attr(test, test)]
    pub fn decode_rejects_index_out_of_range() {
        let fragment = encode_fragment(
            VideoHeader {
                keyframe: false,
                frame_no: 0,
    ...
    #[cfg_attr(test, test)]
    pub fn frame_no_comparison_wraps() {
