...
pub mod tests {
    ...
    #[cfg_attr(test, test)]
    pub fn plays_in_order_after_prefill() {
    ...
    #[cfg_attr(test, test)]
    pub fn reordered_arrival_is_absorbed() {
        let mut jb = MinimalJitter::new(2, 6);
        jb.insert(1, frame(1));
        jb.insert(0, frame(0));
        jb.insert(3, frame(3));
    ...
    #[cfg_attr(test, test)]
    pub fn isolated_loss_reports_gap_and_stays_aligned() {
        let mut jb = MinimalJitter::new(2, 6);
        jb.insert(0, frame(0));
        jb.insert(1, frame(1));
        assert_eq!(jb.tick(), PlayoutStep::Frame(frame(0)));
    ...
    #[cfg_attr(test, test)]
    pub fn multi_frame_gap_reports_each_missing_tick() {
    ...
    #[cfg_attr(test, test)]
    pub fn underrun_grows_depth_and_refills() {
    ...
    #[cfg_attr(test, test)]
    pub fn late_packet_is_dropped_not_replayed() {
        let mut jb = MinimalJitter::new(1, 6);
        jb.insert(0, frame(0));
        jb.insert(1, frame(1));
        assert_eq!(jb.tick(), PlayoutStep::Frame(frame(0)));
    ...
    #[cfg_attr(test, test)]
    pub fn seq_wraparound_is_seamless() {
        let mut jb = MinimalJitter::new(1, 6);
